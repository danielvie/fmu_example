...
def fmu_prepare(target_path: str):
    ...
    Path(f"{target_path}/binaries/darwin64").mkdir(parents=True, exist_ok=True)
    ...
    shutil.copy("cpp/zig-out/aarch64-macos/libBouncingBall.dylib", f"{target_path}/binaries/darwin64/BouncingBall.dylib")
